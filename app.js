...
app.use('/adsv2', express.static(path.join(__dirname, 'utility-web-v2')));
...
app.get('/adsv2/*',cors(), function(req, res) {
  res.sendFile(path.join(__dirname,'utility-web-v2','index.html'));
});
